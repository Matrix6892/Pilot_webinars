...
function assertFenceKremlin(result) {
  ...
  for (const pattern of [
    ...
    /коричнев/iu,
    /(?:историческ[^.]{0,80}палитр|не\s+выбира\p{L}*[^.]{0,80}палитр[^.]{0,100}историческ[^.]{0,80}(?:красн|кирпич)|каноническ[^.]{0,80}(?:красн|кирпич)|(?:красн|кирпич)[^.]{0,80}каноническ|облик[^.]{0,80}(?:сохран|охран)|облик[^.]{0,200}(?:красн|кирпич)[^.]{0,160}перекраск[^.]{0,80}не\s+соглас)/iu,
