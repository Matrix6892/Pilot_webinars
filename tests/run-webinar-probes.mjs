...
function assertFenceKremlin(result) {
  ...
  for (const pattern of [
    ...
    /коричнев/iu,
    /(?:историческ[^.]{0,80}палитр|не\s+выбира\p{L}*[^.]{0,80}палитр[^.]{0,100}историческ[^.]{0,80}(?:красн|кирпич)|каноническ[^.]{0,80}(?:красн|кирпич)|(?:красн|кирпич)[^.]{0,80}каноническ|облик[^.]{0,80}(?:сохран|охран))/iu,
