...
export const KREMLIN_COLOR_GUIDANCE_PATTERN =
  /(?:историческ[^.]{0,80}палитр|не\s+выбира\p{L}*[^.]{0,80}палитр[^.]{0,100}историческ[^.]{0,80}(?:красн|кирпич)|каноническ[^.]{0,80}(?:красн|кирпич)|(?:красн|кирпич)[^.]{0,80}каноническ|сохран\p{L}*[^.]{0,80}историческ[^.]{0,80}облик[^.]{0,80}(?:красн|кирпич)|облик[^.]{0,80}(?:сохран|охран)|облик[^.]{0,200}(?:красн|кирпич)[^.]{0,160}перекраск[^.]{0,80}не\s+соглас)/iu;
