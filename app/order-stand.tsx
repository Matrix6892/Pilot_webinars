      ...
      <main id="top">
          ...
          <div className="hero-status">
            ...
            <ul className="hero-roles">
              ...
              <li>
                ...
                <small>
                  {bridgeOnline
                    ? "DeepSeek V4 Flash отдельным вторым запуском проверяет факты, числа и обещания."
        ...
        <section className="control-story">
          <div className="control-intro">
            ...
            <p>
              {bridgeOnline
                ? `${modelLabel(selectedModel)} обрабатывает заказ по готовым правилам. Второй запуск DeepSeek V4 Flash отдельно проверяет факты и обещания. Программа подтверждает цены и остатки перед каждым действием.`
          ...
          <div className="control-grid">
            ...
            <article>
              ...
              <p>
                {bridgeOnline
                  ? "GPT-5.6 Sol подготовила правила и критерии. DeepSeek V4 Flash отдельным вторым запуском проверяет факты и обещания каждого ответа. Команда может передать журнал GPT-5.6 Sol для новой редакции инструкции; руководитель выбирает правки."
        ...
        {name === "instructions" && (
          <>
            <p className="modal-lead">
              ...
              DeepSeek V4 Flash отдельным вторым запуском проверяет результат. Записанный
