...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description:
      "Интерактивный стенд: заказ, живой склад, цены других поставщиков, ИИ-проверка и готовое коммерческое решение.",
    metadataBase: origin ? new URL(origin) : undefined,
    openGraph: {
      title: "Колер — как агент сохраняет заказ",
      description:
        "Напишите заказ и проследите, как агент проверяет факты, склад, цены других поставщиков и правила продаж.",
      type: "website",
