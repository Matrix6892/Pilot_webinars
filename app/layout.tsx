...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description:
      "Интерактивный стенд: заказ, живой склад, учебные цены поставщиков, проверка моделей и готовое коммерческое решение.",
    metadataBase: origin ? new URL(origin) : undefined,
    openGraph: {
      title: "Колер — как агент сохраняет заказ",
      description:
        "Напишите заказ и проследите, как агент проверяет факты, склад, учебные цены, открытые источники и правила продаж.",
      type: "website",
