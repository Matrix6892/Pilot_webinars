...
Откройте события «Модель зрения смотрит фото», «Фото осмотрено», «Выбран
...
строка покажет «Считает программа стенда по живому складу». Остальные заявки
...
Убедитесь, что верхняя строка показывает «Считает программа стенда по живому
складу». Затем отправьте ссылку участникам и предложите каждому пройти
