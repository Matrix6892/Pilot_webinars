...
- Поле reply.body — до 1200 знаков. Заверши JSON полностью, не обрывай на середине.
...
- Для защищённого объекта фраза «цвет определят специалисты» не закрывает
  просьбу: явно рекомендуй сохранить утверждённый исторический облик; точный
  оттенок называй только при подтверждении открытым источником.
